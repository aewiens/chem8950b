#!/usr/bin/env python3
import sys, psi4, configparser, numpy as np
sys.path.append('../mp2/')
from uhf import UHF
from mp2 import MP2
	...
	def computeEnergy(self):
		...
		for i in range(self.maxiter):
			...
			if dE < self.conv and dT < self.tConv: 
				...
				print("Final CEPA0 energy: {:20.12f}".format( self.E0 + self. Ec ) )
				print("Compare to psi4:    {:20.12f}".format( self.psiCEPA0( self.options)) )
				print('----------------------------------------------------------------------')
				break
